...
<el-table-column label="内容" width="240" min-width="180px">
    ...
    >
      <template slot-scope="{ row, $index }">
         <el-badge is-dot  style="margin-right: 10px;" v-if="!row.is_comment_check">
           <el-button size="mini" type="default" @click="checkComment(row, true)">查看评论</el-button>
         </el-badge>
         <el-button size="mini" type="default" @click="checkComment(row, false)" v-else>查看评论</el-button>
                                          ...
                                          >
                                            ...
                                            <el-table-column label="评论时间" width="155">
                                              <template slot-scope="{ row }">
                                                ...
                                                >
                                                <template slot-scope="{ row, $index }">
                                                <el-button size="mini" type="danger" @click="handleEvaluationDelete(row, $index)">删除</el-button>
                                            </template>
                                            </el-table-column>
                                          </el-table>
                                        </el-main>
                                  ...
                                  >
                                    ...
                                    <el-table-column label="评论时间" width="170">
                                      <template slot-scope="{ row }">
                                        ...
                                        >
                                        <template slot-scope="{ row, $index }">
                                        <el-button size="mini" type="danger" @click="handleCommentDelete(row, $index)">删除</el-button>
                                    </template>
                                    </el-table-column>
                                  </el-table>
                                </el-main>
